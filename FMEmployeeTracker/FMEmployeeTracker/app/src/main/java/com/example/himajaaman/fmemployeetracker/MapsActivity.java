...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener,GoogleMap.OnMarkerClickListener, LocationListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*if ( != null) {
            String latitude = Intent.getString("lat");
            String longitude = Intent.getString("lng");
            System.out.println("In maps activity: lat " + latitude +" long:" + longitude);
        }*/
    ...
    public void onMapReady(final GoogleMap googleMap) {
        ...
        LatLng sydney = new LatLng(35, -90);
        mMap.addMarker(new MarkerOptions().position(sydney).title("Employee Is Here"));
